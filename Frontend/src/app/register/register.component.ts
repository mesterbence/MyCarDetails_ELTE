...
export class RegisterComponent implements OnInit {
    ...
    onRegisterSubmit() {
        if (this.registerForm.get('username')?.value !== "" &&
            ...
            if (this.registerForm.get('email')?.getRawValue().match(this.emailPattern)) {
                ...
                this.snackBar.open("Az e-mail cím formátuma nem megfelelő!", 'Bezárás', {verticalPosition: 'top', duration: 5000});
            }
        } else {
            this.snackBar.open("A mezők kitöltése kötelező!", 'Bezárás', {verticalPosition: 'top', duration: 5000});
        }
