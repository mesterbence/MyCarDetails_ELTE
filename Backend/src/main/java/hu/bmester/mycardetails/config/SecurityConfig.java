...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/api/cost/costs").hasRole("ADMIN")
                .antMatchers("/api/service/serivces").hasRole("ADMIN")
                .antMatchers("/api/user/users").hasRole("ADMIN")
                .antMatchers("/api/car/**").hasRole("USER")
                .antMatchers("/api/cost/**").hasRole("USER")
                .antMatchers("/api/fueltype/**").hasRole("USER")
                .antMatchers("/api/service/**").hasRole("USER")
